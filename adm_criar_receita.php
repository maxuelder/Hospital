...
<body>
    ...
    <div class="row">
      <div class="input-field col s3">
          <input id="txtCpf" type="text" class="validate" name = "txtCpf" required min = "11">
          <label for="cpf">Cpf</label>
      </div>
      <div class="input-field col s5">
              <input onclick="JavaScript:location.href='adm_criar_receita1.php?cpf='+document.getElementById('txtCpf').value"
                  id="txtNome" type="text" class="validate" name = "txtNome" >
                  
              <label for="nome">Nome </label>
          </div>
          <div class="input-field col s4">
              <input id="txtAlergia" type="text" class="validate" name = "txtAlergia">
      ...
      <div class="row">
          ...
          <div class="input-field col s4">
              <input id="txtRemedio" type="text" class="validate" name = "txtRemedio">
              <label for="nome">Remédio </label>
          </div>
          <div class="input-field col s8  ">
              <input id="txtDescricao" type="text" class="validate" name = "txtDescricao">
      ...
      <div class="row">
          <div class="input-field col s12">
              <input id="txtMedico" type="text" class="validate" name = "txtMedico">
