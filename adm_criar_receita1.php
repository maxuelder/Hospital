            ...
            <form action="insReceita.php" method="post" id="adm_criar_receita" name = "adm_criar_receita" class="col s12">
              <div class="row">
                ...
                <div class="input-field col s5">
                        <input id="txtNome" type="text" class="validate" name = "txtNome" value = "<?php echo $nome;?>">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s4">
                        <input id="txtRemedio" type="text" class="validate" name = "txtRemedio"required minlength = "3">
                        <label for="nome">Remédio </label>
                    </div>
                    <div class="input-field col s8  ">
                        <input id="txtDescricao" type="text" class="validate" name = "txtDescricao"
                        onclick="JavaScript:location.href='adm_criar_receita2.php?cpf=' +
                            <?php echo $cpf;?> + '&remedio='+ document.getElementById('txtRemedio').value">
