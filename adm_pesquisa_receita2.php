<?php
    ...
    $sql  = "SELECT * FROM receita WHERE  (cpf like '%$cpf%')";
    ...
    <div class="row">
        ...
        <thead class="thead-dark" >
            ...
            <tr  class="black-text  accent-4"  >
                ...
                <td><a href="adm_editar_receita.php?cpf=<?php echo $id;?>" >Alterar</a></td>
                <td><a href = '#' onclick = "retirar(<?php echo $id?>)" >Retirar</a></td>
            ...
            <tr  class="black-text  accent-4"  >
                ...
                <td><?php echo $usuario['nomeRemedio']; ?></td>
                <td><?php echo $usuario['descricao']; ?></td>
                <td><?php echo $usuario['quantidade']; ?></td>
                <td><?php echo $usuario['data']; ?></td>
                <td><?php echo $usuario['vencimentoReceita']; ?></td>
                <td><?php echo $usuario['medico']; ?></td>
                <td><a href="adm_editar_receita.php?cpf=<?php echo $usuario['id']; ?>" >Alterar</a></td>
                <td><a href = '#' onclick = "retirar(<?php echo $usuario['id'];?>)" >Retirar</a></td>
        ...
        <script>
            function delet(a){
                ...
                if(oi == true){
                    ...
                    location.href='adm_remove_receita.php?id='+a
                }else{
                    location.href='adm_pesquisar_receita.php'
                }
                }
            function retirar(b){
                
                var oi = confirm("Você tem certeza que deseja retirar?")
                if(oi == true){
                    
                    location.href='adm_retirar1_receita.php?id='+b
                }else{
                    location.href='adm_pesquisar_receita.php'
                }
